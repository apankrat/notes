/*
inline wchar_t toupper_2258(wchar_t ch)
{
	extern const wchar_t casemap_u_2258[];
	return ch + casemap_u_2258[ casemap_u_2258[ casemap_u_2258[ch >> 8] + ((ch >> 3) & 0x1f) ] + (ch & 0x07) ];
}
*/

const wchar_t casemap_u_2258[1129] = 
{
